...
import { faMicrochip } from '@fortawesome/free-solid-svg-icons'; // Icône LinkedIn

const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Grégory Henry
        {/* <div className="test"> */}
          <svg class="home__atom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" >
            {/* Noyau */}
            <circle cx="100" cy="100" r="10" className="nucleus" />

            {/* Anneaux / Orbites */}
            <ellipse cx="100" cy="100" rx="70" ry="30" className="ring ring1" />
            <ellipse cx="100" cy="100" rx="70" ry="30" className="ring ring2" />
            <ellipse cx="100" cy="100" rx="70" ry="30" className="ring ring3" />
          </svg>
        {/* </div> */}
      ...
      <p className="home__description">Passionate About Innovation and Problem-Solving. Transforming ideas into reality.</p>
