...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_rboadgr', 'template_a55j7ra', form.current, {
                publicKey: 'hKHezRjB1ehZdxYfl',
            })
            .then(() => {
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            {/*insérer icone ici avec classe contact__card-icon*/}
                            <FontAwesomeIcon icon={faEnvelope} className="contact__card-icon" />

                            <h3 className="contact__card-title">Email</h3>
                            <span className="contact__card-data">
                                gregory.henry@outlook.com
                            </span>
                            <a href="mailto:gregory.henry@outlook.com" className="contact__button" target="_blank" rel="noopener noreferrer">Write me {" "}
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://wa.me/32487654321" className="contact__button" target="_blank" rel="noopener noreferrer">Write me {" "}
                                {/*insérer icone ici et ajouter classe contact__button-icon*/}
                                <ArrowForwardTwoToneIcon className="contact__button-icon" />
                            </a>
                        </div>
